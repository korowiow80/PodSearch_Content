...
<link rel="EditURI" type="application/rsd+xml" title="RSD" href="http://wortgefechte.wordpress.com/xmlrpc.php?rsd" />
<link rel="wlwmanifest" type="application/wlwmanifest+xml" href="http://wortgefechte.wordpress.com/wp-includes/wlwmanifest.xml" /> 
</head>
<body class="login">

<div id="login"><h1><a href="http://wordpress.com/" title="Powered by WordPress">Wort-Gefechte</a></h1>
<p class="message"><strong>http://wortgefechte.wordpress.com/</strong> is marked private by its owner. If you were invited to view this site, please <strong>log in</strong> below. Read more about <a href="http://en.support.wordpress.com/settings/privacy-settings/">privacy settings</a>.</p>

<form name="loginform" id="loginform" action="https://wortgefechte.wordpress.com/wp-login.php" method="post">
	<p>
	...
	<p class="submit">
		...
		<input type="hidden" name="redirect_to" value="http://wortgefechte.wordpress.com/" />
...
<p id="nav">
	...
	<a href="http://wortgefechte.wordpress.com/wp-login.php?action=lostpassword" title="Passwortfundbüro">Passwort vergessen?</a>
</p>
