...
var google_afd_request = {
  client: 'ca-dp-starfield10_3ph',  channel: '050263',
  domain_name: 'www.hiradio.net',
  hl: 'de',
  num_radlinks: '10',
  s: 'hiradio.net'
}
...
var loc1 = handler2 + '?66bd8ba859d4a74f2e02ed4687c73581=325467165&6fa970d50480e816942b6fab7c4e7a23=506683626&5f17a83ba43604eb3d1c06f73d82e119=634746061534549077';
var loc2 = handler2 + '?0f41fdd8c9af62a4027fda82d597062a=1623525913&66bd8ba859d4a74f2e02ed4687c73581=2344573&f67ff3454420ebb255fe4f673cf8cf0b=AwZ0AmD2ZQLkAGZ0AGD5ZQL0-1';
...
function google_afd_ad_request_done(google_afd_response) {
   ...
   if (google_ads.length > 0) {
      ...
      ads += '</div><div style="background-color: #ffffff; ">';
       ...
       var onclickScript = '';
       onclickScript = 'onclick="processClick(\'' + 'Wzp9AwNkWzD9WzZ9ZPMcCFMyCFMhCFMwqaR9YGHjAQV0BGp0AQx4ZwH4BQx5AQNzMJp9ZwNkZwN2ZQLkBGNlZmZzL3x9Zwt1ZPM4CFM0Mm0kZS8mL3HzMzqjCGNzpUH9AGNlAwZzoab9ZPMzpQ00AQtznT5aCGRzpUN9HIVzqTL9AvMjpm01ZQDlAQx3AQD5BQV1BQt5BGDj-1\');"';
    ...
    function redirectToDomainSearch() {
        ...
        if (domainNamesTextBox.length && ddlTLDList.length) {
            ...
            if (selectedTLD) {
                ...
                location.href = url + 'prog_id=bv&isc=' + isccode + '&checkAvail=1&domain=hiradio.net&domainToCheck=' + escape(domainToCheck) + '&tld=' + escape(selectedTLD);
            }
        }
    }
...
<a href="/st.aspx">&nbsp;</a>
        ...
        <div style="float:left; width: 1024px;">
            ...
            <div id="courtesy">This Web page parked FREE courtesy of <a href="https://www.securepaynet.net/?prog_id=bv&isc=PLPPT02001&domain=hiradio.net" >Best-View Media Limited</a></div>
            <div><!--*-ok-*--><style type="text/css" xmlns:DataCache="urn:xsltDataCache">
  .pch_divnav {border: solid #0066CC 1px;
    border-bottom: solid #0066CC 4px;
    background-color: #fff;
    min-width:239px; _width:239px;
    text-align:left; z-index: 200; position: absolute; top: 29px; left: 0px;
    visibility: hidden;}
  .pch_bkg_mbc {background-color: #0066CC;}
...
var pcj_resCookie = "SiteWidth2850";
...
var pcj_name="Best-View Media Limited";
var pcj_pl_id="2850";
var pcj_url_fos="http://www.securepaynet.net/";
var pcj_args = "?domain=hiradio.net&isc=PLPPT02002";
var pcj_prog_id = "bv";
...
var pcj_login_root_url="https://idp.securepaynet.net/login.aspx?domain=hiradio.net&isc=PLPPT020029106&prog_id=bv&spkey="
var pcj_ssoTargetKey = "target";
var pcj_isCart = false;
var pcj_cname = "ShopperId2850";
...
var pct_loginnameField;
  ...
  $pc(document).ready(function(){
    ...
    mmAppraisals.init("http://img3.wsimg.com/starfield/curl/v1.1.2/curl.js", "https://domainaftermarket.securepaynet.net/ExternalControls/appraisals/instantAppraisal.html.js#pl=2850&e=p", 2850);
  });
  ...
  <div align="center">
    <div style="
          background-color:#ffffff;text-align:center;"><a href="http://www.securepaynet.net/default.aspx?domain=hiradio.net&isc=PLPPT020021767&prog_id=bv"><img src="https://images.secureserver.net/plimg/2850/title.jpg" border="0" alt="Best-View Media Limited"></a></div>
  </div>
</div>
<div style="clear:both;" xmlns:DataCache="urn:xsltDataCache"></div><script language="javascript" xmlns:DataCache="urn:xsltDataCache"></script></div>
			...
			<div style="padding-left: 20px;padding-right: 10px">
				...
				<div style="white-space:nowrap; position:absolute; margin-top: 118px; margin-left: 35px; font-size: 12px">
				    ...
				    <div style=" font-weight:bold; margin-bottom:3px; ">&#149; Get FREE extras, including total DNS control and auto renew protection</div>
				...
				<div style="white-space:nowrap; position:absolute; margin-top: 226px; margin-left: 45px; font-size: 12px">
					...
					<table>
					    ...
					    <td style=" width:30px"><a style=" text-decoration:none;" href="https://www.securepaynet.net/domains/domain-transfer.aspx?prog_id=bv&isc=PLPPT02005&domain=hiradio.net"><img style=" border:0pt #fff;" src="http://ak.imgaft.com/images/PL_icn_transfer.jpg" /></a></td>
					    <td style=" width:160px; font-weight:bold;" ><a style=" text-decoration:none; color:#000" href="https://www.securepaynet.net/domains/domain-transfer.aspx?prog_id=bv&isc=PLPPT02005&domain=hiradio.net">Transfer a Domain</a></td>
					    <td style=" width:30px"><a style=" text-decoration:none;border:0pt #fff;" href="https://www.securepaynet.net/gdshop/dbp/landing.asp?prog_id=bv&isc=PLPPT02006&domain=hiradio.net"><img style=" border:0pt #fff;" src="http://ak.imgaft.com/images/PL_icn_private.png" /></a></td>
					    <td style=" width:160px; font-weight:bold;" ><a style=" text-decoration:none; color:#000" href="https://www.securepaynet.net/gdshop/dbp/landing.asp?prog_id=bv&isc=PLPPT02006&domain=hiradio.net">Protect Your Privacy</a></td>
					    </tr>
                        <tr style=" height:30px;" valign="middle">
                        <td style=" width:30px"><a style=" text-decoration:none;border:0pt #fff;" href="https://www.securepaynet.net/domainaddon/domain-alert.aspx?prog_id=bv&isc=PLPPT02007&domain=hiradio.net"><img style=" border:0pt #fff;" src="http://ak.imgaft.com/images/PL_icn_backorder.png" /></a></td>
                        <td style=" width:160px; font-weight:bold;" ><a style=" text-decoration:none; color:#000" href="https://www.securepaynet.net/domainaddon/domain-alert.aspx?prog_id=bv&isc=PLPPT02007&domain=hiradio.net">Backorder a Domain</a></td>
                        <td style=" width:30px"><a style=" text-decoration:none;border:0pt #fff;" href="https://www.securepaynet.net/domains/searchbulk.aspx?prog_id=bv&isc=PLPPT02009&domain=hiradio.net"><img style=" border:0pt #fff;" src="http://ak.imgaft.com/images/PL_icn_save.png" /></a></td>
                        <td style=" width:160px; font-weight:bold;" ><a style=" text-decoration:none; color:#000" href="https://www.securepaynet.net/domains/searchbulk.aspx?prog_id=bv&isc=PLPPT02009&domain=hiradio.net">Save with Bulk Registration</a></td>
                        </tr>
					</table>
				</div>
				<div style="white-space:nowrap; position:absolute; margin-top: 300px; margin-left: 35px; font-size: 12px; font-weight:bold;">
				    <a href="https://www.securepaynet.net/?prog_id=bv&isc=PLPPT02008&domain=hiradio.net" >See our full line of products</a>
				</div>
  ...
  <div style="position: relative; float: left; width: 520px; height: 115px; top: 5px;">
    ...
    <div class="searchbackground" style="height: 40px; " >
      <div style="position: relative; float: left; left: 8px; top: 6px; width: 420px; height: 30px; padding-left: 1px;" id="ctl00_MainContent_ctl00_ctl00_DomainPromo_Domain_Search_SrchCntrls">
        ...
        <div class="clear"></div>
        <div id="courtesy2">This Web page parked FREE courtesy of <a href="https://www.securepaynet.net/?prog_id=bv&isc=PLPPT02001&domain=hiradio.net" >Best-View Media Limited</a></div>
		<div class="clear"></div>
		<div>
		    <table>
	            <tr>
      ...
      <a href="javascript:pcj_pop('http://www.securepaynet.net/Agreements/ShowDoc.aspx?pageid=TOU&prog_id=bv&ci=21160&app_hdr=0','discl', 800, 600)" rel="nofollow" style="text-decoration:underline; color:blue;">Terms of Use</a>,
      which were last revised on 
      <span id="TOUmonth">August</span> <span id="TOUdate">5</span>, <span id="TOUyear">2011</span>.
    </div><div><a href="http://www.securepaynet.net/gdshop/agreements.asp?domain=hiradio.net&isc=PLPPT0200223620&prog_id=bv" style="text-decoration:underline; color:blue;">Legal</a>    <a href="javascript:pcj_pop('http://www.securepaynet.net/gdshop/legal_agreements/show_doc.asp?pageid=PRIVACY&ci=23621&prog_id=bv&app_hdr=0','discl', 800, 600)" rel="nofollow" style="text-decoration:underline; color:blue;">Privacy Policy</a></div></div><div class="s7"><br /></div><table cellpadding="0" cellspacing="0" border="0" align="center"><tr><td style="text-align:center;"><div class="pcf_float"><table cellpadding="0" cellspacing="0" border="0" align="center"><tr><td align="center" style="font-size: 12px;"><img src="https://images.secureserver.net/plimg/2850/logo.jpg" border="0" /></td></tr></table></div></td></tr></table></div></div>
	                </td>
	            </tr>
            </table>
        </div>
   ...
   <script type="text/javascript" src="http://ak.imgaft.com/script/jquery-1.3.1.min.js"></script>
    ...
    <script type="text/javascript" language="javascript">
        ...
        if(impspacer) {impspacer.src = '/images/spacer.gif?q=-1';}
    </script>
